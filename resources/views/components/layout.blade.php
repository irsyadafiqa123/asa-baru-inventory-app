...
<head>
    ...
    <title>@yield('title') - {{ config('app.name', 'Toko Plastik Asa Baru') }} </title>
...
<body class="lg:flex lg:relative max-w-480 mx-auto w-full">

    {{-- Sidebar --}}
    <x-sidebar />

    {{-- Pages --}}
    <main class="w-full lg:ml-64 lg:overflow-y-auto lg:max-h-screen">
        <section class="p-6 space-y-8 w-full">
            @yield('header')
            @yield('content')
        </section>
    </main>
